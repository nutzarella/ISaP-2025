...
public class MessageDigestExample {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        final String message2 = "We would like to provide data integrity.";
        ...
        digestAlgorithm.update(message.getBytes());
        digestAlgorithm.update(message2.getBytes());
...
//        final byte[] hashed = digestAlgorithm.digest(message.getBytes(StandardCharsets.UTF_8));
        final byte[] hashed = digestAlgorithm.digest();
